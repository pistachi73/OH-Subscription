...
import { NotAllowedChapter } from "../not-allowed-chapter";
...
export const MobileChapterPlayer = () => {
  ...
  const hasToken = Boolean(chapter.playbackToken);
        ...
        {hasToken && (
          <>
            ...
            >
              <MediaTimeDisplay
                class={cn(
                  "bg-transparent font-sans p-0  xl:text-base  text-xs",
                )}
              />
              <MediaTimeRange />
            </MediaControlBar>
