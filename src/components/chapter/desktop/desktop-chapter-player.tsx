...
import { DesktopChapterCommunity } from "../desktop/desktop-chapter-community";
import { DesktopChapterDetails } from "../desktop/desktop-chapter-details";
import { DesktopChapterList } from "../desktop/desktop-chapter-list";
import { DesktopChapterTranscript } from "../desktop/desktop-chapter-transcript";
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-full z-0">
        <DesktopChapterCommunity />
        {chapter.transcript && <DesktopChapterTranscript />}
        <DesktopChapterList />
