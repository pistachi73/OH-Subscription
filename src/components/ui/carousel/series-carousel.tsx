...
const SeriesCard = ({
  ...
  return (
    <button className="group/video relative flex aspect-video w-full items-center justify-center overflow-hidden rounded-sm ">
      <span className="absolute left-1 top-1 z-20 h-fit shrink-0 rounded bg-primary-800/70 px-1 py-0.5 text-2xs font-medium text-white">
        B1 - B2
      </span>
      <div className="z-20 w-full self-end bg-gradient-to-t from-primary-800 to-primary/0 p-2 pt-4">
...
export const SeriesCarousel = ({
  ...
  return (
    <div className="z-10 my-8 lg:my-[2vw]">
